class HsCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/say8425/hs-cli/releases/download/v0.3.0/hs-darwin-arm64"
      sha256 "02892ce7048794854394f86c58fa754596deca6f97c934091a8c3c17521a05e9"
    end
    on_intel do
      url "https://github.com/say8425/hs-cli/releases/download/v0.3.0/hs-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/say8425/hs-cli/releases/download/v0.3.0/hs-linux-arm64"
      sha256 "5f379fe548f131b7c32b935633eeeb3125e43cbdca8080a827e970d6ffc02d69"
    end
    on_intel do
      url "https://github.com/say8425/hs-cli/releases/download/v0.3.0/hs-linux-x64"
